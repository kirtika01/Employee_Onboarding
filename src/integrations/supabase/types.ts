  ...
  public: {
    Tables: {
      ...
      form_fields: {
        ...
        Relationships: [
          {
            foreignKeyName: "form_fields_department_id_fkey"
            columns: ["department_id"]
            isOneToOne: false
            referencedRelation: "departments"
            referencedColumns: ["id"]
      ...
      department_document_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "department_document_templates_department_id_fkey"
            columns: ["department_id"]
            isOneToOne: false
            referencedRelation: "departments"
            referencedColumns: ["id"]
      ...
      department_signup_forms: {
        ...
        Relationships: [
          {
            foreignKeyName: "department_signup_forms_department_id_fkey"
            columns: ["department_id"]
            isOneToOne: false
            referencedRelation: "departments"
            referencedColumns: ["id"]
      ...
      department_signup_form_submissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "department_signup_form_submissions_form_id_fkey"
            columns: ["form_id"]
            isOneToOne: false
            referencedRelation: "department_signup_forms"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "department_signup_form_submissions_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
